...
SECRET_KEY = 'django-insecure-4_t#dric+ojqtoe2j9mygx_!n*b8s4yo!^e9v=(j#*wo#xaavl'
...
MIDDLEWARE = [
    ...
    'MyApp.middleware.UnauthenticatedRedirectMiddleware',  # Custom middleware for 30s unauthenticated redirect
]
